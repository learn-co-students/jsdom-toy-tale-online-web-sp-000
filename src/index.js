...
//     toyCarDiv.classList.add('card')
//     toyCarDiv.id = `${data.id}`
...
//     toyCarDiv.innerHTML = toyCard;
//     divCollect.appendChild(toyCarDiv)
